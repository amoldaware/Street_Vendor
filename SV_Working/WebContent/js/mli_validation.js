...
var STRING_PATTERN = /^([a-zA-z.-/& ]{3,100})$/;
var MLI_PATTERN = /^([a-zA-Z0-9&-()./ ]{3,100})$/;
var TEXT_PATTERN = /^[a-zA-Z-() ]*$/;
var TEXT_ADDRESS = /^[a-zA-Z0-9&\s,.'-()/ ]*$/;
var ADDRESS_PATTERN=/^[a-zA-Z0-9&\s,.'-/()]{3,}$/;
//var NAME_PATTERN = /^[a-zA-Z0-9 ]*$/;
var SHORTNAME_PATTERN = /^([a-zA-z-()/ ]{2,50})$/;
...
var PHONE_PATTERN = /^[0-9]{8}|[0-9]{7}|[0-9]{6}$/;
...
document.getElementById("shortNameerror").innerHTML = "Should be between 2 - 50 characters.";
errorFlag = false;
}
...
document.getElementById("longNameerror").innerHTML = "Should be between 3 - 100 characters.";
errorFlag = false;
}
...
document.getElementById("phoneCodeerror").innerHTML = "Phone Number Should be 6-8 Digits";
errorFlag = false;
}
...
document.getElementById("contactPersonerror").innerHTML = "Should be between 3 - 100 characters.";
errorFlag = false;
}
...
function validateMLIEditRegistration()
{
