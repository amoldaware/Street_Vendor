...
int all_eror_cnt = 0;
int eror_cnt = 0;
String refUploadId = (String)request.getAttribute("upldId");
...
<!-- <TABLE width="100%" border="0" cellpadding="0" cellspacing="0"> -->
	 	<form:form id="A" action="/SV/mliMaker.html" class="form-horizontal">
 ...
 -->			<!-- <TD> -->
			<TABLE width="100%" border="1" align="left" cellpadding="0"
				...
				<TR>
					...
					<tr>	
					<td><font color=green>Your file has been uploaded. Please find the reference id of upload: <%=refUploadId%></font></td>
					</tr><tr>
					<td>Please <a href="/SV/getBulkUploadTrack.html">click here</a> to view the <font color=red>status</font> of uploaded file or go through <font color=red>the path:</font> <b>Application Processing -> Bulk Upload Status</b></td>
						<%-- <td>1</td>
						<td>Error</td>
						<%if(all_eror_cnt>0){%>
...
function backMLIDetails() {
	alert('Back');
	document.getElementById('A').action = "/SV/mliMaker.html";
