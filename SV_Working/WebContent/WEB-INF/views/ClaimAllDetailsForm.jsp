...
<nav aria-label="breadcrumb">
   <ol class="breadcrumb cus-breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/SV/ClaimStatusWiseDetailsReport.html">Claim Status Wise Report</a></li>  
     ...
     <li class="breadcrumb-item"><a href="/SV/ClaimDetailsAllReportDataBack.html?claimStatus=${formData.claimStatus}&fromDate=${formData.fromDate}&toDate=${formData.toDate}">Claim Status Wise Report Data</a></li>
