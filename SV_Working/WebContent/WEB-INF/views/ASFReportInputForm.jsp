...
<script language="javascript">
	function submitMLIForm() {
		document.getElementById('A').action = "/SV/AsfReportDetailList.html";
		...
		<div class="container-fluid">
			<div>
				...
				<div class="frm-section">
					...
					<div class="col-md-12">
						 <h2 align="center" class="heading">ASF Summary Details </h2>
                             ...
                             <div class="col-md-3 col-sm-4 col-xs-12 mar-top21">
								...
								<div class="col-md-12 prl-10">
											<label>MLI Long Name : <span style="color:red">*</span></label>								
												...
												<%-- <form:option value="ALL" label="ALL ASF Summary Details"/> --%>
		...
		<div class="container-fluid">
			<div class="frm-section">
				...
				<!-- <button style="border:none !important;" > -->
		    		<a href="ASFReportDetailDownload.html">
		    		...
		    		<!-- </button> -->
						...
						<div class="d-inlineblock mt-35">
										<form:form action="/SV/ASFbackButton.html">
