...
<body onload="noBack();">
	...
	<div class="main-section">
		<div class="container-fluid">
			<!-- <div class="row"> -->
			<div>
				<form:form method="POST" id="A" action="/SV/AppClosureRequestDetails.html"
					...
					<div class="frm-section">
						<div class="col-md-12">
							...
							<h5 class="sub-head">
								<strong>Request For Closure</strong>
							</h5>
							<div class="col-md-2 col-sm-4 col-xs-12">
								<div class="form-group">
									<div class="col-md-12 prl-10">
										<form:label path="MEMBER_ID">Member ID<span
												style="color: red;">*</span>
										</form:label>
										<form:input path="MEMBER_ID" id="MEMBER_ID" value="${MEMBER_ID}"
							...
							<div class="d-inlineblock mt-25">
								<input class="btn btn-reset" type="button" value="Submit" onclick="appClosureDetails()"/> 
								<input
								...
								<c:forEach items="${dataListReturn}" var="dataList">
									<tr>
										...
										<td><c:out value="${dataList.appClosureDate}" /></td>
									 	<td><c:out value="${dataList.appClosureReturnRemarks}" /></td>
										<%-- <td><c:out value="${dataList.loanType}" /></td> --%>
										<td align="center"><a
											href="EditAppClosureDetails.html?Cgpan=${dataList.CGPAN}"
...
<script type="text/javascript">
	...
	function appClosureDetails() {
		document.getElementById('A').action = "/SV/AppClosureRequestDetails.html";
		document.getElementById('A').submit();
	}
</script>
