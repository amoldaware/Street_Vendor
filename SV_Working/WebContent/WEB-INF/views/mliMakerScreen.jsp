...
function validate_fileupload(ID){
    ...
    if(inp.files.length === 0){
      ...
      return false;
    	...
    	document.getElementById('A').action = "/SV/fileUploaded.html";
...
function validate_fileCleanUP(ID){
    ...
    if(inp.files.length=== 0){
      ...
      return false;
    	...
    	document.getElementById('A').action = "/SV/fileCleanup.html";
		document.getElementById('A').submit();
    }
}
...
<body oncontextmenu="return false;" onload="errorMessage()" bgcolor="#E0FFFF">
...
<!-- <div class="row"> -->
	<div>	
		...
		<input type="hidden" name="csrfPreventionSalt" value="${csrfPreventionSalt}"/>
		  <h5 class="notification-message"><strong>${message}</strong></h5>
			...
			<div class="col-md-2 col-sm-4 col-xs-12">
			  <div class="form-group">
			  <div class="col-md-12 prl-10">
			   <form:label path="pendingExp1">Unutilized Exposure Limit(&#8377;):</form:label>
			    <!-- <div class="col-sm-8"> -->
			...
			<div class="clearfix"></div>
			<hr style=" margin: 5px 0;  border: 1px solid #d8d8d8;">
			<div class="col-lg-12"><label style ="color: #f44336;font-size: 12px !important;">Only disbursed cases under PM SVANidhi are to be lodged/uploaded for Guarantee Coverage with CGTMSE</label></div>
			<div class="col-md-2 col-sm-4 col-xs-12">
			  <div class="form-group">
			  <div class="col-md-12 prl-10">
			    <label>Step : 1</label>
           ...
           <a href="downLoadExcelFile.html" >Download Excel Format</a>
			    </div>	    			   
			  </div>
			</div>
			<!-- <div class="col-md-2 col-sm-4 col-xs-12">
			...
			<!--  <input type="file" name="file" size="28" id="upload" class="form-control cus-control" disabled />
			 -->	 <input type="file" name="file" size="28" id="upload" class="form-control cus-control" />
				...
				<label style ="color: #f44336;">Please upload file xls format only</label>
				</div>	    			   
			  </div>
			</div>
		...
		<c:if test="${empty errormessage}">
			...
			<h5 style="font-size:60;color: red" align="left"><strong>${errmessage}</strong></h5>
		</div>
	</div>
	...
	function exitMLIDetails() {
		//alert('Exit');
		document.getElementById('A').action = "/SV/nbfcMakerHomeBack.html";
		document.getElementById('A').submit();
	}
