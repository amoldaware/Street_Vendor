...
<html>
	...
	<body >
		...
		<ol class="breadcrumb cus-breadcrumb">
			...
			<a href="/SV/claimLoadgementApprovalCGTMSE.html?MLIName=${MLIID}">Claim Lodgement
					Approval</a></li>
		...
		<nav aria-label="breadcrumb">
		<ol class="breadcrumb cus-breadcrumb">
				<li><a href="/SV/claimLoadgementApprovalMLI.html">Claim Lodgement
					Approval</a></li>
			<li class="breadcrumb-item active" aria-current="page">Claim CheckList Details</li>
		</ol>
		</nav>
						...
						<div class="col-md-12">
							...
							<div class="col-md-3 col-sm-4 col-xs-12 mar-top21">
								...
								<div class="col-md-3 col-sm-4 col-xs-12 mar-top21">
									<div class="form-group">
										<div class="col-md-12 prl-10">
											<label>Date of issue of Recall Notice:</label>
								...
								<table class="table table-bordered table-hover cus-table mb-0">
									...
									<tr>
										...
										<td><form:input path="totalOsAmt"  id="totalOsAmt" value="${formData.totalOsAmtStr}"  size="20"  readonly="true"  class="form-control cus-control" /></td>
											<td><form:input path="recovery" id="recovery" value="${formData.recovery}" size="20"  class="form-control cus-control" readonly="true"/></td>
										<td><form:input path="subsidyAmt"
												id="subsidyAmt1" value="${formData.subsidyAmt}" size="20"
										...
										<table class="table table-bordered table-hover cus-table mb-0">
										    ...
										    <td>
												<form:select path="reductionReason2"   id="reductionReason2"  disabled="false" class="form-control cus-control" >
											 			<form:option value="${formData.reductionReason2}" /></form:select>
											</td>
										</tr>
										<tr>
											<td></td>
								...
								<div class="col-md-3 col-sm-4 col-xs-12 mar-top21">
									<div class="form-group">
										<div class="col-md-12 prl-10">
											...
											<form:input
													path="nbfcMakerClaimLodgRemarks" id="nbfcMakerClaimLodgRemarks" value="${formData.nbfcMakerClaimLodgRemarks}"
