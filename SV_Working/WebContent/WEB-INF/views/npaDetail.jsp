...
<body onload="noBack();">
	...
	<div class="main-section">
		<div class="container-fluid">
			<!-- <div class="row"> -->
			<div>
				<form:form method="POST" id="A" action="/SV/npaDetailsData.html"
					...
					<div class="frm-section">
						<div class="col-md-12">
							...
							<c:if test="${!empty dataList}">
								...
								<h2 class="heading"
									style="text-align: center; margin: 15px 0 !important;">NPA
									Detail</h2>
	...
	<%
								...
								<c:forEach items="${dataListReturn}" var="dataList">
									<tr>
										...
										<td><c:out value="${dataList.npaReason}" /></td>
										<td><c:out value="${dataList.npaDt}" /></td>
									 	<td><c:out value="${dataList.remarks}" /></td>
										<%-- <td><c:out value="${dataList.loanType}" /></td> --%>
										<td align="center"><a
											href="npaEditUpdate.html?Cgpan=${dataList.CGPAN}"
											class="btn-edit">Edit</a> </td>
									</tr>
								</c:forEach>
							</table>
