...
function isNumberKey(evt, element) {
	...
	function calTotOutstandingAsOnDateOfLodgementOfClaim(id) {
		/*if(document.getElementById('recovery').value==null || document.getElementById('recovery').value==""){
			document.getElementById("requiredmodeRecovery").value=0;
		}*/
		var subsidyAmount=0;
		...
		//var subsidyAmount = document.getElementById('subsidyAmt').value;
		...
		if (parseInt(totalOsAmount) > parseInt(latestOsAmount)) {
			...
			document.getElementById('osAmtClaim').value = parseInt(latestOsAmount)- parseInt(recoveryMadeAmt)-parseInt(subsidyAmount);
			var AMount=parseInt(latestOsAmount)- parseInt(recoveryMadeAmt)-parseInt(subsidyAmount);
			...
			var AMount=parseInt(totalOsAmount)- parseInt(recoveryMadeAmt)-parseInt(subsidyAmount);
			if(parseInt(AMount)>0){
				document.getElementById('osAmtClaim').value=AMount;
			}else{
				document.getElementById('osAmtClaim').value='0.0';
			...
			//document.getElementById('osAmtClaim').value = parseInt(totalOsAmount)- parseInt(recoveryMadeAmt)-parseInt(subsidyAmount);
		} /* else {
			document.getElementById('osAmtClaim').value = parseInt(totalOsAmount)- parseInt(recoveryMadeAmt)-parseInt(subsidyAmount);
		} */
	...
	function claimLodgementFormValidatiOnSubmit(ID){
		...
		if(ID=='Y'){
			...
			if(document.getElementById('subsidyAmt').value=="0" || document.getElementById('subsidyAmt').value=="0.0" || document.getElementById('subsidyAmt').value=="" ||document.getElementById('dateOfSubsidy').value==null){
	...
	if (!(option7[0].checked || option7[1].checked)) {
	    dot.getElementById("requiredLliReported").innerHTML="Field is mandatory.";
	    chkflag=chkflag-1; 
	}else{
	...
	/*if(document.getElementById('resonFillingSuit').value==""||document.getElementById('resonFillingSuit').value==null){
		document.getElementById("requiredResonFillingSuit").innerHTML="Satisfactory reason is mandatory.";
		chkflag=chkflag-1; 
  	}else{
...
/* 			
	...
	if(chkflag==5){
		document.getElementById('editClaimDataReturnByNBFCMakerFormId').action = "/SV/editClaimDataReturnByNBFCMaker.html";
		document.getElementById('editClaimDataReturnByNBFCMakerFormId').submit();
	}	
		...
		<div class="container-fluid">
			<nav aria-label="breadcrumb">
					  <ol class="breadcrumb cus-breadcrumb">
					    <li class="breadcrumb-item"><a href="/SV/displayClaimLodgementForm.html">Claim Lodgement For First Installment</a></li>  
					    <li class="breadcrumb-item active" aria-current="page">Claim Re-Lodgement</li>
					  </ol>
				</nav>
			...
			<div>
				<div class="frm-section">
					...
					<% int counter=0;%>
					<c:if test="${!empty formData3}">
					<label>Return Reasons:</label>
					</c:if>	
				<c:forEach items="${formData3}" var="list">
				<lable<% if(counter%2==0){%>bgcolor="silver" <%}%>>
				</lable>	<br/>			 <label><%=counter+1%> </label>
			    <label color="red"><span color="red"><c:out value="${list.returnReasons}"/></span></label>	
			...
			<div class="col-md-12"  style="color: red;">
			  <label color="red">*<span color="red"><c:out value="${formData1.returnReasonsRemarks}"/></span></label>	
			 
			 </div>
			<hr></hr>
					<div class="col-md-12">
						<form:form action="" method="POST" class="form-horizontal"
							enctype="multipart/form-data" id="editClaimDataReturnByNBFCMakerFormId">
                 	 	...
                 	 	<input id="sanctionAmt1" name="sanctionAmt" type="hidden" value="${formData.sanctionAmt}"> 
							...
							<div class="col-md-2 col-sm-4 col-xs-12 mar-top21">
								<div class="form-group">
									<div class="col-md-12 prl-10">
										<label>CGPAN :</label>
										<form:input path="cgpan" id="cgpan" value="" size="20" style=""
								...
								<div class="form-group">
									<div class="col-md-12 prl-10">
										...
										<label class="d-block">Forum through which legal
											...
											class="form-control cus-control">
											<form:option id="${formData1.forum}" value="${formData1.forum}"></form:option>
								...
								<div class="form-group">
									<div class="col-md-12 prl-10">
										<div id="requiredResonFillingSuit"
											Class="displayErrorMessageInRedColor"></div>
										<label>Provide satisfactory reason for Initiation of legal action before NPA date(if applicable)<span style="color: red">*</span>:
										</label> <label class="d-block"> <form:input
								...
								<div class="form-group">
									<div class="col-md-12 prl-10">
										...
										<c:when test="${formData1.anySubsidyInvolved=='Y'}">
										   <form:radiobutton path="anySubsidyInvolved" id="anySubsidyInvolved" value="Y" onclick="claimLodgementFormValidatiOnSubmit(this.value);disableField(this.value)" checked="checked"/>Yes
											<form:radiobutton path="anySubsidyInvolved" id="anySubsidyInvolved" value="N" onclick="claimLodgementFormValidatiOnSubmit(this.value);disableField(this.value)" />No
											</c:when>
											<c:when test="${formData1.anySubsidyInvolved=='N'}">
										   <form:radiobutton path="anySubsidyInvolved" id="anySubsidyInvolved" value="Y" onclick="claimLodgementFormValidatiOnSubmit(this.value);disableField(this.value)" />Yes
											<form:radiobutton path="anySubsidyInvolved" id="anySubsidyInvolved" value="N" onclick="claimLodgementFormValidatiOnSubmit(this.value);disableField(this.value)" checked="checked"/>No
											</c:when>
											</c:choose>
										</label>
									</div>
						...
						<table class="table table-bordered table-hover cus-table mb-0">
								<thead>
									<tr>
										<th style="width: 150px;">CGPAN</th><br>
								...
								<tr>
									<td><form:input path="cgPanTL" id="cgPanTL" style="padding:2px;"
											value="${formData.cgpan}" readonly="true"
									...
									<td>
											...
											Class="displayErrorMessageInRedColor"></div> 
											<form:select path="modeRecovery" id="modeRecovery"  class="form-control cus-control">
												<form:option id="${formData1.modeRecovery}" value="${formData1.modeRecovery}"></form:option>
												...
												<form:option value="Irrecovable Demand notice" label="Irrecovable Demand notice" />
							...
							<table class="table table-bordered table-hover cus-table mb-0">
								...
								<tr>
									...
									<td><form:input path="networthOfPromotor"
											...
											readonly="true" style="text-align: right"
											class="form-control cus-control" /></td>
									<td>	<form:select  path="reductionReason" id="reductionReason"  class="form-control cus-control" readonly="true">
								...
								<tr>
										...
										<table class="table table-bordered table-hover cus-table mb-0">
											...
											<tr>
												<td><form:input path="landValue2" id="landValue2"
														...
														class="form-control cus-control"
														type="number" min="0" oninput="validity.valid||(value='');" onchange="caltotalPrefermentOfClaim(this);"/></td>
									...
									<form:select path="reductionReason2" id="reductionReason2" disabled="false"
											class="form-control cus-control">	
										<%-- 	<form:option value="${formData1.reductionReason2}" lable="${formData1.reductionReason2}"/> --%>
										...
										<td>
											...
											<c:choose>
												<c:when test="${formData2.activityEligible=='Y'}">
													<form:radiobutton path="activityEligible" value="Y" checked="checked"  onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="activityEligible" value="N" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:when test="${formData2.activityEligible=='N'}">
													...
													<form:radiobutton path="activityEligible" value="N" checked="checked" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:otherwise>
													<form:radiobutton path="activityEligible" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="activityEligible" value="N" onclick="claimLodgementCheckListValidation()"/>No
										...
										<div id="requiredcibil"
										 ...
										 <c:choose>
												<c:when test="${formData2.cibil=='Y'}">
													<form:radiobutton path="cibil" value="Y" checked="checked"  onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="cibil" value="N" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:when test="${formData2.cibil=='N'}">
													<form:radiobutton path="cibil" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="cibil" value="N" checked="checked" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:otherwise>
													<form:radiobutton path="cibil" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="cibil" value="N" onclick="claimLodgementCheckListValidation()"/>No
										...
										<div id="requiredrateCharge"
											...
											<c:choose>
												<c:when test="${formData2.rateCharge=='Y'}">
													<form:radiobutton path="rateCharge" value="Y" checked="checked"  onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="rateCharge" value="N" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:when test="${formData2.rateCharge=='N'}">
													<form:radiobutton path="rateCharge" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="rateCharge" value="N" checked="checked" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:otherwise>
													<form:radiobutton path="rateCharge" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="rateCharge" value="N" onclick="claimLodgementCheckListValidation()"/>No
										...
										<div id="requireddateOfNPAAsRBI"
											...
											<c:choose>
												<c:when test="${formData2.dateOfNPAAsRBI=='Y'}">
													<form:radiobutton path="dateOfNPAAsRBI" value="Y" checked="checked"  onclick="claimLodgementCheckListValidation()"/>Yes
												...
												<c:when test="${formData2.dateOfNPAAsRBI=='N'}">
													...
													<form:radiobutton path="dateOfNPAAsRBI" value="N" checked="checked" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:otherwise>
													<form:radiobutton path="dateOfNPAAsRBI" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="dateOfNPAAsRBI" value="N" onclick="claimLodgementCheckListValidation()"/>No
										...
										<td>
											...
											<c:choose>
												<c:when test="${formData2.apprisalDisbursement=='Y'}">
													<form:radiobutton path="apprisalDisbursement" value="Y" checked="checked"  onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="apprisalDisbursement" value="N" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:when test="${formData2.apprisalDisbursement=='N'}">
													<form:radiobutton path="apprisalDisbursement" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="apprisalDisbursement" value="N" checked="checked" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:otherwise>
													<form:radiobutton path="apprisalDisbursement" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="apprisalDisbursement" value="N" onclick="claimLodgementCheckListValidation()"/>No
										...
										<td>
											...
											<c:choose>
												<c:when test="${formData2.postDisbursement=='Y'}">
													<form:radiobutton path="postDisbursement" value="Y" checked="checked"  onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="postDisbursement" value="N" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:when test="${formData2.postDisbursement=='N'}">
													...
													<form:radiobutton path="postDisbursement" value="N" checked="checked" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:otherwise>
													<form:radiobutton path="postDisbursement" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="postDisbursement" value="N" onclick="claimLodgementCheckListValidation()"/>No
										...
										<td>
											...
											<c:choose>
												<c:when test="${formData2.exerciseCarried=='Y'}">
													<form:radiobutton path="exerciseCarried" value="Y" checked="checked"  onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="exerciseCarried" value="N" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:when test="${formData2.exerciseCarried=='N'}">
													...
													<form:radiobutton path="exerciseCarried" value="N" checked="checked" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:otherwise>
													<form:radiobutton path="exerciseCarried" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="exerciseCarried" value="N" onclick="claimLodgementCheckListValidation()"/>No
											...
											<td>
												<c:choose>
													<c:when test="${formData2.internalRating=='Y'}">
														<form:radiobutton path="internalRating" value="Y" checked="checked"  onclick="disableField(this.value);claimLodgementCheckListValidation();"/>Yes
														<form:radiobutton path="internalRating" value="N" onclick="disableField(this.value);claimLodgementCheckListValidation();"/>No
														<form:radiobutton path="internalRating" id ="internalNA" value="NA" onclick="disableField(this.value);claimLodgementCheckListValidation();"/>NA
												 	</c:when>
													<c:when test="${formData2.internalRating=='N'}">
														...
														<form:radiobutton path="internalRating" value="N" checked="checked" onclick="disableField(this.value);claimLodgementCheckListValidation();"/>No
														<form:radiobutton path="internalRating" id ="internalNA" value="NA" checked="checked" onclick="disableField(this.value);claimLodgementCheckListValidation();"/>NA
												 	</c:when>
													<c:otherwise>
														<form:radiobutton path="internalRating" value="Y" onclick="disableField(this.value);claimLodgementCheckListValidation();"/>Yes
														<form:radiobutton path="internalRating" value="N" onclick="disableField(this.value);claimLodgementCheckListValidation();"/>No
										...
										<div id="requiredrecoverPertaining"
											...
											<c:choose>
												<c:when test="${formData2.recoverPertaining=='Y'}">
													<form:radiobutton path="recoverPertaining" value="Y" checked="checked"  onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="recoverPertaining" value="N" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:when test="${formData2.recoverPertaining=='N'}">
													...
													<form:radiobutton path="recoverPertaining" value="N" checked="checked" onclick="claimLodgementCheckListValidation()"/>No
											 	</c:when>
												<c:otherwise>
													<form:radiobutton path="recoverPertaining" value="Y" onclick="claimLodgementCheckListValidation()"/>Yes
													<form:radiobutton path="recoverPertaining" value="N" onclick="claimLodgementCheckListValidation()"/>No
							...
							<div class="col-md-4 col-sm-4 col-xs-12 pt-20">
								...
								<c:choose>
									...
									<c:when test="${formData1.claimLodgementCertificate=='N'}">
										<form:checkbox path="claimLodgementCertificate"
