...
<!-- <div class="row"> -->
  ...
  <ol class="breadcrumb cus-breadcrumb">
    <li class="breadcrumb-item"><a href="/SV/betweenTwoDateAppropriation.html">Appropriation 2</a></li>  
   ...
   /*  background-color: #4ba4bf; blue shade*/ background-color:#a641a9; color:white	"><strong>Payment Details of &nbsp; ${paymentId}</strong></h6>
			  ...
			  <div class="form-group">
			    <label class="control-label col-sm-5 prl-10">Date of Realisation</label>
			    <div class="col-sm-7">
			    <div class="pay-amount">	
			  ...
			  <div class="col-md-6 prl-10 payment-col">
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
				    <label class="control-label col-sm-5 prl-10">Received Amount :</label>
				    <div class="col-sm-7">
				    <div class="pay-amount">	
				   		<form:input path="receivedAmount" size="28" value="" class="form-control"  />    
			...
			<table id="myTable" class="table table-bordered table-hover cus-table mt-10 mb-5 danRpDataTable">
				<thead>
				<!-- <tr >
    ...
    if ($selectedCBs.length === 0) {
    	...
    	//	 approveCount=$selectedCBs.length-1;
    	 ...
    	 //   }
    	    ...
    	    if(chkflag==5){
    		document.getElementById('A').action = "/SV/updateAppropriateData.html?rpno=" +"<c:out value="${paymentId}"/>";
