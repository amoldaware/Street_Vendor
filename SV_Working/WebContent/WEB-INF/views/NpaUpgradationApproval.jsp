...
<div class="main-section">
   ...
   <ol class="breadcrumb cus-breadcrumb">
    <li class="breadcrumb-item"><a href="/SV/NPAUpgradationApproval.html">NPA Upgradation Approval/Return</a></li>  
  </ol> 
</nav>
			...
			<thead>
					...
					<c:forEach items="${dataList}" var="dataList">
						...
						<tr>
							...
							<td><a href="/SV/NpaUpgradationUpdate.html?Cgpan=${dataList.CGPAN}"><c:out value="${dataList.CGPAN}" /></a></td>
...
document.getElementById("upgradationReturnRemarks").disabled=true; 
	...
	function NpaUpgradationApprove() {
		...
		if ($selectedCBs.length === 0) {
			...
			document.getElementById('A').action = "/SV/SaveNPAUpgradationApprove.html";
	...
	function NpaUpgradationReject() {
		...
		if ($selectedCBs.length === 0) {
			...
			//alert("hellow "+hiddenValue); 
			document.getElementById('A').action = "/SV/SaveNPAUpgradationReject.html";
			document.getElementById('A').submit();
			}else{
