			...
			<TABLE width="100%" border="1" align="left" cellpadding="0"
				...
				<TR>
					...
					<tr>
					 ...
					 --%>	
					 <td><a href="exportToNpaFile.html?fileType=XLSType&FlowLevel=SuccessDataList"><%=success_cnt%></a></td>
						<%}else{ %>
						<td>0</td>
						<%}%>
					...
					<tr>	
						...
						<%if(unsuccess_cnt>0){%>
						<td><a href="exportToNpaFile.html?fileType=XLSType&FlowLevel=UnSuccessDataList"><%=unsuccess_cnt%></a></td>
						<%}else{ %>
						<td>0</td>
						<%}%>
					</tr>					 
					<tr>	
						...
						<td>Error</td>
						<%if(all_eror_cnt>0){%>
						<td><a href="exportToNpaFile.html?fileType=XLSType&FlowLevel=Allerrors"><%=all_eror_cnt%></a></td>
						<%}else{ %>
						<td>0</td>
						<%}%>
					</tr>
