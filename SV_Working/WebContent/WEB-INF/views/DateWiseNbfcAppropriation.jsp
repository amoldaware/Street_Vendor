...
function getDataDateWise() {
	...
	document.getElementById('submitFormId').action = "/SV/dateWiseGfBatchApplicaiton.html";
		...
		<div class="container-fluid">
			<div>
				<div class="frm-section">
					<div class="col-md-12">
						<h2 align="center" class="heading">Search Appropriation for Approval/Rejection</h2>
