...
<form:form method="GET" id="A">
	<table id="myTable" class="table table-bordered table-hover cus-table mt-10 mb-0">					
		...
		<tr>
			<td bgcolor="#dd6f00" colspan=2><a href="/SV/disbursedborwerDetails.html?fileName=${fileName}&portfolioRate=${portfolioRate}">Disbursed Cases</a></td> 
		    <td bgcolor="#dd6f00" colspan=2><a href="/SV/nonDisbursedborwerDetails.html?fileName=${fileName}&portfolioRate=${portfolioRate}">Non Disbursed Cases</a></td>
		<thead>
		<tr>			
			<th >SR.NO.</th>
...
function buckToHome() {
	//alert('Back');
	document.getElementById('A').action = "/SV/danAllocation.html";
