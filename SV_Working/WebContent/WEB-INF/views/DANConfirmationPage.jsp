...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb cus-breadcrumb">
    <li class="breadcrumb-item"><a href="/SV/danAllocation.html">DAN Allocation</a></li>  
...
<!-- <div class="row"> -->
	...
	<%-- <h1 align="center">Confirm Guarantee Fee Allocation</h1>
	<hr>
	<form:form method="GET" id="A">
		...
		<c:if test="${!empty danDetailList}">
				...
				<tr>
					...
					<td class="tableHeader1">DAN Number</td>
					<td class="tableHeader1">Total Fee</td>
					<td class="tableHeader1">Select for RP Generation</td>
	...
	<div align="center"><input type="submit" value="Generate RP Number" onclick="submitForApproval()" class="button" />
...
function buckToHome() {
	...
	document.getElementById('A').action = "/nbfc/danAllocation.html";
...
//	alert('Approve');
	...
	alert(totalOfAmo); */
	document.getElementById('A').action = "/SV/rpNumberGenration.html";
	document.getElementById('A').submit();
}
