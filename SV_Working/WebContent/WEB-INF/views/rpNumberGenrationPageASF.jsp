...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb cus-breadcrumb">
    <li class="breadcrumb-item"><a href="/SV/danAllocationASF.html">DAN Allocation For ASF</a></li>  
    <li class="breadcrumb-item"><a href="/SV/danAllocationASF.html">Confirm Guarantee Fee Allocation</a></li>  
...
<script type="text/javascript">
	...
	function submitToProcess() {
		//alert('Back');
		document.getElementById('A').action = "/SV/rpNumberConfirmationASF.html";
		document.getElementById('A').submit();
	}
