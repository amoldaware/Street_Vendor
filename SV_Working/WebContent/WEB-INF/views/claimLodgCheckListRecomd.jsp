...
<body bgcolor="#E0FFFF">
	...
	<%String userRole = (String) session.getAttribute("uRole"); 
		...
		<ol class="breadcrumb cus-breadcrumb">
			...
			<a href="/SV/claimLoadgementApprovalCGTMSE.html?MLIName=${MLIID}">claimLoadgement
					Approval</a></li>
		...
		<ol class="breadcrumb cus-breadcrumb">
			<li class="breadcrumb-item"><a
				href="/SV/claimLoadgementApprovalMLI.html">Claim Lodgement
					Approval</a></li>
			<li class="breadcrumb-item active" aria-current="page">Claim CheckList Details</li>
		</ol>
		</nav>
						...
						<table
							...
							<tr>
								...
								<th style="min-width: 90px;">Yes / No</th>
									...
									<th style="min-width: 90px;">Recommendation Status</th>
							...
							<tr>
								...
								<td><c:choose>
									...
									<td><c:out value="${danDetailList.activityEligibleStatus}"/></td>
							...
							<tr>
								...
								<td><c:choose>
									...
									<td><c:out value="${danDetailList.cibilStatus}"/></td>
							...
							<tr>
								...
								<td><c:choose>
									...
									<td><c:out value="${danDetailList.rateChargeStatus}"/></td>
 ...
 --%>
							...
							<tr>
								...
								<td><c:choose>
									...
									<td><c:out value="${danDetailList.dateOfNPAAsRBIStatus}"/></td>
							...
							<%-- <tr>
								...
								<td><c:choose>
									...
									<td><c:out value="${danDetailList.whetherOutstandingStatus}"/></td>
							...
							<tr>
								...
								<td><c:choose>
									...
									<td><c:out value="${danDetailList.apprisalDisbursementStatus}"/></td>
							...
							<tr>
								...
								<td><c:choose>
									...
									<td><c:out value="${danDetailList.postDisbursementStatus}"/></td>
							...
							<tr>
								...
								<td><c:choose>
									...
									<td><c:out value="${danDetailList.exerciseCarriedStatus}"/></td>
							...
							<tr>
								...
								<td><c:choose>
										<c:when test="${danDetailList.internalRating=='Y'}">
											<form:radiobutton path="internalRating" value="Y" checked="checked" />Yes
										...
										<c:when test="${danDetailList.internalRating=='N'}">
											<form:radiobutton path="internalRating" value="Y" disabled="true"/>Yes
                                             <form:radiobutton path="internalRating" value="N" checked="checked" />No
                                             	<form:radiobutton path="internalRating" value="NA" disabled="true"/>NA
											 		</c:when>
						...
						<%-- 		<td><form:input path="internalRatingRemarks"
							...
							<tr>
								...
								<td>Whether all the recoveries pertaining to the account
									...
									<td><c:out value="${danDetailList.recoverPertainingStatus}"/></td>
