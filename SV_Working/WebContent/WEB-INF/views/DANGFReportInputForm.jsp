...
<script language="javascript">
	function submitMLIForm() {
		document.getElementById('A').action = "/SV/DANGFReportDetailList.html";
		...
		<div class="container-fluid">
			<div>
				...
				<div class="frm-section">
					...
					<div class="col-md-12">
						 <h2 align="center" class="heading">DAN GF Report</h2>
		...
		<div class="container-fluid">
			<div class="frm-section">
				...
				<!-- <button style="border:none !important;" > -->
		    		<a href="DANGFReportDetailDownload.html">
						  ...
						  <c:forEach items="${rows1}" var="item" varStatus="status">
									<tr>
									  ...
									  <!--  // <a href="a.html?fruit=apple" id="a">Hello</a> -->
										<td align="center"> <a href="/SV/DANIDwise.html?danId=${item[0]}">${item[0]} </a></td>
					...
					<center>
						<div class="d-inlineblock mt-35">
										<form:form action="/SV/DANGFbackButton.html">
		...
		<div class="container-fluid">
			<div class="frm-section">
				<div class="col-md-12">
				 <div style="text-align: left;">
				<!-- <button style="border:none !important;" > -->
		    		<a href="DemandAdviceNumberDetailDownload.html">
		    			<img src="images/excel.png" alt="" data-toggle="tooltip" title="Export To Excel"  >
		    		</a>
		    		<!-- </button> -->
		    		 </div>
						...
						<tbody>
						  ...
						  <c:forEach items="${rows3}" var="item" varStatus="status">
									<tr>
									    <td><%=counter + 1%></td>
									    <td align="center"> <a href="/SV/CGPNDetails.html?cgpnNo=${item[5]}">${item[0]} </a></td>  
										<td align="center">${item[1]}</td>
										<td align="center">${item[2]}</td>
										<td align="center">${item[3]}</td>
										<td align="center">${item[4]}</td>
					...
					<div align="center">
						<!-- <div class="d-inlineblock mt-35"> -->
										<form:form action="/SV/DANGFbackButton1.html">
										<input type="submit" value="Back" class="btn btn-reset"
											class="btn btn-reset" />
											</form:form>
									 </div>
 ...
 -->
               ...
               <table cellpadding=3
						...
						<tr>
	                     ...
	                     <form:form action="/SV/DANGFbackButton2.html">
										<input type="submit" value="Back" class="btn btn-reset"
											class="btn btn-reset" />
											</form:form>
