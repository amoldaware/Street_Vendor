...
public class MLIRegBean {
	...
	@Size(min = 3, max = 100, message = "Long name should be between 3 - 100 characters.")
	...
	@Size(min = 2, max = 50, message = "Short name should be between 2 - 50 characters.")
...
//	@NotEmpty(message = "Date of Rating is Required.")
	...
	private MultipartFile mlifile;
	
	
	public MultipartFile getMlifile() {
		return mlifile;
	}
	public void setMlifile(MultipartFile mlifile) {
		this.mlifile = mlifile;
	}
