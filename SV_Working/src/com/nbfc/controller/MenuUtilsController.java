...
@Controller
public class MenuUtilsController {
	 Login login = null;
	@Autowired
	...
	public  Map<String, Object> prepareMenu(HttpSession session,
		...
		Map<String, Object> modelAct = new HashMap<String, Object>();
			if (Role.equals("CMAKER")) {
				...
				List<UserActivity> urtMakerUploadList = userActivityService.getActivity("CGTMSEMAKER","urt_upload_cgtmse");//vivek
				 
				List<UserActivity> claimPaymentList = userActivityService.getActivity("CGTMSEMAKER","claim_Payment_Initition");
			...
			if (Role.equals("CCHECKER")) {
				...
				//modelAct.put("claimUploadCGTMSE", userActivityService.getActivity("CGTMSECHECKER", "claim_upload_cgtmse")); //added by umar kr 21/01/021
				modelAct.put("claimUploadCGTMSE", userActivityService.getActivity("CGTMSECHECKER", "claim-approved-data"));//Added by Sarita 23032022
				modelAct.put("bankMandateFormCgtmscApproval", userActivityService.getActivity("CGTMSECHECKER", "bankMandateForm_Cgtmsc_Approval"));//added by vivek 24-01-2021
