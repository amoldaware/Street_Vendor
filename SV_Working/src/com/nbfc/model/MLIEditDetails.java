...
public class MLIEditDetails {
	
	
	@Id
	@Column(name="LONG_NAME")
	private String longName;
	@Column(name="MLI_TYPE")
	...
	*/@Column(name="REMARKS")
	...
	//private Date cgtmse_maker_date =new Date();
	...
	public void setCgtmse_maker_date(Date cgtmse_maker_date) {
		this.cgtmse_maker_date = new Date();
	}
	...
	public String toString() {
		return "MLIEditDetails [longName=" + longName + ", mem_bnk_id="
				+ mem_bnk_id + ", mem_zne_id=" + mem_zne_id + ", mem_brn_id="
				+ mem_brn_id + ", shortName=" + shortName + ", companyAddress="
				+ companyAddress + ", city=" + city + ", state=" + state
				+ ", district=" + district + ", pincode=" + pincode
				+ ", landlineNumber=" + landlineNumber + ", emailId=" + emailId
				+ ", contactPerson=" + contactPerson + ", mobileNUmber="
				+ mobileNUmber + ", faxNumber=" + faxNumber
				...
				+ ratingDate + ", userID=" + userID + ", status=" + status
				+ ", mem_bnk_name=" + mem_bnk_name + ", phone_code="
				+ phone_code + ", mem_status=" + mem_status + ", mem_mcgf="
				+ mem_mcgf + ", remarks=" + remarks + ", cgtmse_maker_id="
				+ cgtmse_maker_id + ", cgtmse_maker_date=" + cgtmse_maker_date
				+ "]";
	}

	public MLIEditDetails() {
		super();
	}
