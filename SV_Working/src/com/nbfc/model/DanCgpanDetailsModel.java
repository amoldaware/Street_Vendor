...
public class DanCgpanDetailsModel implements Serializable {
	@Id
	@Column(name="DAN_ID")
	...
	private char DCI_APPROPRIATION_FLAG;
	
	
	
	
	public char getDCI_APPROPRIATION_FLAG() {
		return DCI_APPROPRIATION_FLAG;
	}

	public void setDCI_APPROPRIATION_FLAG(char dCI_APPROPRIATION_FLAG) {
