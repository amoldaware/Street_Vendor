...
@Entity
@Table(name = "AUD_NBFC_MEMBER_INFO")
public class AudMLiDetails {
	...
	@Column(name="AUD_BY")
	private String aud_by;
	@Column(name="AUD_DATE")
	private Date aud_date=new Date();
	...
	public void setCgtmse_checker_date(Date cgtmse_checker_date) {
		this.cgtmse_checker_date = cgtmse_checker_date;
	}
	public String getFaxCodeE() {
		return faxCodeE;
	}
	public void setFaxCodeE(String faxCodeE) {
		this.faxCodeE = faxCodeE;
	}
